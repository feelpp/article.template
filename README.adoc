...
![GitHub Release](https://img.shields.io/github/v/release/feelpp/article.template)
![GitHub Actions Workflow Status](https://img.shields.io/github/actions/workflow/status/feelpp/article.template/latex.yml)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/feelpp/article.template/total)
